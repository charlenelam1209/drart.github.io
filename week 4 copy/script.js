...
kitty.two = 'two'; // object are changable and mutable (you can add to them after they are created)
console.log(kitty);

// kitty.travel(); // error beacause you can invoke undefined as a function
